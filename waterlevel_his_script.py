...
f.write("San Francisco & %0.4f & %0.4f & %0.4f & %0.4f & %0.4f \\\ \\hline \n" % (ms, bias, r2, rms, lag))
# plotting
...
mfreq, mspec = an.band_avg(mtimes, np.asarray(mwaterlevel)[:,0])
ms, bias, r2, rms, lag = an.model_metrics(times, mwaterleveli, times, waterlevel)
f.write("Point Reyes & %0.4f & %0.4f & %0.4f & %0.4f & %0.4f \\\ \\hline \n" % (ms, bias, r2, rms, lag))
# plotting
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(time, waterlevel, color='cornflowerblue')
ax.plot(mtime, mwaterlevel, color='turquoise', alpha=0.75)
...
mfreq, mspec = an.band_avg(mtimes, np.asarray(mwaterlevel)[:,0])
ms, bias, r2, rms, lag = an.model_metrics(times, mwaterleveli, times, waterlevel)
f.write("Richmond & %0.4f & %0.4f & %0.4f & %0.4f & %0.4f \\\ \\hline \n" % (ms, bias, r2, rms, lag))
# plotting
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(time, waterlevel, color='cornflowerblue')
ax.plot(mtime, mwaterlevel, color='turquoise', alpha=0.75)
...
mfreq, mspec = an.band_avg(mtimes, np.asarray(mwaterlevel)[:,0])
ms, bias, r2, rms, lag = an.model_metrics(times, mwaterleveli, times, waterlevel)
f.write("Alameda & %0.4f & %0.4f & %0.4f & %0.4f & %0.4f \\\ \\hline \n" % (ms, bias, r2, rms, lag))
# plotting
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(time, waterlevel, color='cornflowerblue')
ax.plot(mtime, mwaterlevel, color='turquoise', alpha=0.75)
...
mfreq, mspec = an.band_avg(mtimes, np.asarray(mwaterlevel)[:,0])
ms, bias, r2, rms, lag = an.model_metrics(times, mwaterleveli, times, waterlevel)
f.write("Redwood City & %0.4f & %0.4f & %0.4f & %0.4f & %0.4f \\\ \\hline \n" % (ms, bias, r2, rms, lag))
# plotting
fig, ax = plt.subplots(figsize=(6,4))
ax.plot(time, waterlevel, color='cornflowerblue')
ax.plot(mtime, mwaterlevel, color='turquoise', alpha=0.75)
